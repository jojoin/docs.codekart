...
<ul>
  ...
  <li><a href="/p/core_index">核心</a>
    <ul>
      ...
      <li><a href="/p/core_request">request对象扩展</a></li>
      <li><a href="/p/core_callthis">处理程序this对象</a></li>
      <li><a href="/p/core_controller">请求处理</a></li>
      <li><a href="/p/core_route">url路由配置</a></li>
      <li><a href="/p/core_static">静态文件服务</a></li>
    </ul>
  </li>
  <li><a href="/p/view_index">view页面</a>
    <ul>
      <li><a href="/p/view_inherit">页面继承</a></li>
      <li><a href="/p/view_tpl">tpl模板</a></li>
      <li><a href="/p/view_data">模板数据</a></li>
      <li><a href="/p/view_css">css及库</a></li>
      <li><a href="/p/view_js">js及库</a></li>
      <li><a href="/p/view_other">其它</a></li>
    </ul>
  </li>
  <li><a href="/p/db_index">数据库支持</a>
    <ul>
      <li><a href="/p/db_mysql">mysql</a></li>
      <li><a href="/p/db_redis">redis</a></li>
    </ul>
  </li>
