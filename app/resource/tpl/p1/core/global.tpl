...
<big>read.resource(filename,opt,callback)</big>
...
<big>read.config(filename,opt,callback)</big>

<p>与<code>read.resource</code>相同，但是加载<var>config</var>目录下的文件。</p>

<big>read.app(filename,opt,callback)</big>
