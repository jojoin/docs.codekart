...
<p>推荐采用<dfn>npm</dfn>方式安装，这会自动安装最新版的<dfn>Codekart</dfn>以及相关的依赖库，当然也可以下载源码（需要自己安装依赖库），<a href="https://github.com/yangjiePro/Codekart/archive/master.zip">点击下载</a></p>
...
$ mv /home/codekart /home/webname            #更名(webname为你的网站名称)
</code></pre>
...
<p>之后浏览器里打开<a href="http://localhost:82">http://localhost/:82，</a>
  可以看到Codekart框架的<a href="http://codekart.jojoin.com/">主页面</a>，表示框架就已经运行。查看<a href="/p/core_init">框架启动流程</a>。</p>
